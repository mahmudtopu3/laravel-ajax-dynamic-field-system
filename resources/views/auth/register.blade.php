                ...
                <div class="p-5">
                  ...
                  {{ csrf_field() }}
                    ...
                    <div class="form-group">
                      <input id="name" type="text"  class="form-control form-control-user"  aria-describedby="nameHelp" placeholder="Enter Your Name..."  name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                      @if ($errors->has('name'))
